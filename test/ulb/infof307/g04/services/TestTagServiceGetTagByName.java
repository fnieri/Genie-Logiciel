...
public class TestTagServiceGetTagByName {
    ...
    @Test
    public void testGetTagByName() throws IOException, InterruptedException, ApiException {
        ...
        Tag tag = service.getTagByName("newtag");
