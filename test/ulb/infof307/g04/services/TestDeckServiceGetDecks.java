...
public class TestDeckServiceGetDecks {
    ...
    @Test
    public void testGetDecks() throws IOException, InterruptedException, ApiException {
    ...
    @ParameterizedTest
    @MethodSource("getTestGetDecksErrorArguments")
    public <T extends Throwable> void testGetDecksError(int statusCode, Class<T> expectedError) throws IOException, InterruptedException, ApiException {
        HttpResponse<String> response = mock();
        HttpClient client = mock();
        IDeckService service = spy(new DeckService("http://localhost:8000", client));
    ...
    private static Stream<Arguments> getTestGetDecksErrorArguments() {
        return Stream.of(
