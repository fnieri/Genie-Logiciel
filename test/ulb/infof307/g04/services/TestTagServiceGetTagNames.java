...
public class TestTagServiceGetTagNames {
    ...
    @Test
    public void testGetTagNames() throws IOException, InterruptedException, ApiException {
        ...
        List<String> tags = service.getTagNames();
    ...
    @ParameterizedTest
    @MethodSource("getTestGetTagNamesErrorArguments")
    public <T extends Throwable> void testGetTagNamesError(int statusCode, Class<T> expectedError) throws IOException, InterruptedException, ApiException {
        HttpResponse<String> response = mock();
        HttpClient client = mock();
        ITagService service = spy(new TagService("http://localhost:8000", client));
    ...
    private static Stream<Arguments> getTestGetTagNamesErrorArguments() {
        return Stream.of(
